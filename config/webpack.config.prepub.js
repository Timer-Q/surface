...
const HOST = 'wpstatic.mafengwo.net'
const publicPath = `https://${HOST}/${GROUP_NAME}/${SERVER_NAME}/`
      ...
      },
      {
        ...
        oneOf: [
          ...
          // sass loader
          {
            ...
            use: [
              {
                loader: require.resolve('style-loader'), // 将 JS 字符串生成为 style 节点
              },
              {
